...
public class AccountManager {
    ...
    public String getGroupDetails(String groupName) {
        try {
            Connection conn = dbHelper.getConnection();    // Check if the group exists in the special_access_groups table
            ...
            if (!groupRs.next()) {    // Group does not exist, return a message
                 groupRs.close();
            ...
            return "An error occurred while retrieving group details.";
        }
    }
